...

{
...

	{
		...
		XMMATRIX leftCylWorld = XMMatrixTranslation(-3.0f, 1.5f, -10.0f + i * 5.0f);

		XMMATRIX rightCylWorld = XMMatrixTranslation(+3.0f, 1.5f, -10.0f + i * 5.0f);



		XMMATRIX leftSphereWorld = XMMatrixTranslation(-3.0f, 3.5f, -10.0f + i * 5.0f);

		XMMATRIX rightSphereWorld = XMMatrixTranslation(+3.0f, 3.5f, -10.0f + i * 5.0f);
